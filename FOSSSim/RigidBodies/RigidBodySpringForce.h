...
public:
  ...
  RigidBodySpringForce( const scalar& k, const scalar& l0, int rb0, const Vector2s& vc0, int rb1, const Vector2s& vc1, scalar b = 0 );
  ...
  // Query
  scalar k() const { return m_k; }
  scalar l0() const { return m_l0; }
  scalar b() const { return m_b; }
  
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

private:
  friend class MonopodRobot;
