#ifndef __OPENGL_RIGID_BODY_SPRING_FORCE_RENDERER_H__
#define __OPENGL_RIGID_BODY_SPRING_FORCE_RENDERER_H__

#include "FOSSSim/RenderingUtilities.h"
#include "OpenGLRenderer.h"
#include "RigidBodySpringForce.h"

class OpenGLRigidBodySpringForceRenderer : public OpenGLRenderer
{

public:

  OpenGLRigidBodySpringForceRenderer( const RigidBodySpringForce& rbspfrc, const renderingutils::Color& color );
