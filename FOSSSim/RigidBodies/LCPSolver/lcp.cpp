		     ...
		     dReal *w, int nub, dReal *lo, dReal *hi)
{
  ...
  #endif
  for( int i = 0; i < n*nskip; ++i ) L[i] = 0.0;
  ...
  #endif
  for( int i = 0; i < n; ++i ) delta_x[i] = 0.0;
  ...
  #endif
  for( int i = 0; i < n; ++i ) delta_w[i] = 0.0;
  ...
  #endif
  for( int i = 0; i < n; ++i ) Arows[i] = NULL;
